				...
				<div class="main-content-inner">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="col-md-2  "> 
                                                                              ...
                                                                              <div class="panel-body acord">
                                                                                  <div class="col-md-4">
                                                                                     <div class="form-group">
                                                                                           ...
                                                                                           <input name="nombresolicitante" type="text" value="<?php 
                          echo $resultado->NombreSolicitante ;?>" placeholder="Nombre"  class="form-control" required >
                                                                                      </div>  
                          ...
                          echo $resultado->DomicilioSolicitante ;?>" class="form-control">
                                                                                      </div> 
                          ...
                          echo $resultado->CiudadSolicitante ;?>" class="form-control">
                                                                                      </div>
                                                        ...
                                                        echo $resultado->Edad ;?>"  class="form-control">
                                                                                   ...
                                                                                   <div class="col-md-4">
                                                                                     <div class="form-group">
                                                                                           ...
                                                                                           <input name="apellidopasolicitante" required  type="text"value="<?php 
                                                                                            echo $resultado->ApellidoSolPa ;?>" placeholder="Apellido Paterno" class="form-control">
                                                                                      </div> 
                                                                                       <?php echo form_error('apellidopasolicitante'); ?>
                                                                                      <div class="form-group">
                                                                                           <label class="control-label">Número</label> 
                                                                                           <input name="numerosolicitante" type="number" class="form-control" value="<?php 
                                                                                        echo $resultado->NumeroSolicitante ;?>" required >
                                                                                      </div>

                                                                                      <div class="form-group">
                                                                                           <label class="control-label">Colonia</label> 
                                                                                           <input name="coloniasolicitante" type="text" class="form-control" value="<?php 
                                                                                        echo $resultado->ColoniaSolicitante ;?>" required >
                                                                                      </div>
                                                                                      ...
                                                                                      <div class="form-group">
                                                                                           ...
                                                                                           <select class="form-control" name="estadocivs" required >
                                                                                               <option value=""></option>
                                                                                               <option value="Casado" <?php if($resultado->EstadoCivilSolicitante=="Casado"){echo "selected";}?> >Casado</option>
                                                                                               <option value="Soltero" <?php if($resultado->EstadoCivilSolicitante=="Soltero"){echo "selected";}?> >Soltero</option>
                                                                                               <option value="Divorciado"<?php if($resultado->EstadoCivilSolicitante=="Divorciado"){echo "selected";}?> >Divorciado</option>
                                                                                               <option value="Viudo" <?php if($resultado->EstadoCivilSolicitante=="Viudo"){echo "selected";}?> >Viudo</option>
                                                                                           </select>
                                                                                      </div>
                                                                                   ...
                                                                                   <div class="col-md-4">
                                                                                     <div class="form-group">
                                                                                           <label class="control-label">&nbsp;</label> 
                                                                                           <input name="apellidomasolicitante" type="text" placeholder="Apellido Materno" class="form-control" value="<?php 
                                                                                             echo $resultado->ApellidoSolMa ;?>" required >
                                                                                      </div> 
                                                                                      ...
                                                                                      <div class="form-group">
                                                                                           ...
                                                                                           <select class="form-control" name="parentesco">
                                                                                                <option value=""></option>
                                                                                                <option value="Hijo" <?php if($resultado->Parentesco=="Hijo"){echo "selected";}?>>Hijo</option>
                                                                                                <option value="Hija" <?php if($resultado->Parentesco=="Hija"){echo "selected";}?>>Hija</option>
                                                                                                <option value="Madre"<?php if($resultado->Parentesco=="Madre"){echo "selected";}?>>Madre</option>
                                                                                                <option value="Padre"<?php if($resultado->Parentesco=="Padre"){echo "selected";}?>>Padre</option>
                                                                                                <option value="Hermano" <?php if($resultado->Parentesco=="Hermano"){echo "selected";}?>>Hermano</option>
                                                                                                <option value="Hermana"<?php if($resultado->Parentesco=="Hermana"){echo "selected";}?>>Hermana</option>
                                                                                                <option value="Suegro" <?php if($resultado->Parentesco=="Suegro"){echo "selected";}?>>Suegro</option>
                                                                                                <option value="Suegra"<?php if($resultado->Parentesco=="Suegra"){echo "selected";}?>>Suegra</option>
                                                                                                <option value="Primo" <?php if($resultado->Parentesco=="Primo"){echo "selected";}?>>Primo</option>
                                                                                                 <option value="Prima" <?php if($resultado->Parentesco=="Prima"){echo "selected";}?>>Prima</option>
